...
namespace ArtSofteEmployees.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DepartmentID,NameDepartment,Floor")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepartmentID,NameDepartment,Floor")] Department department)
        {
